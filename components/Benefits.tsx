        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="reveal-stagger order-2 lg:order-1">
            ...
            <div className="flex justify-center lg:justify-start mt-8">
              <InteractiveHoverButton text="AGENDAR VISITA AGORA" href={WHATSAPP_LINK} className="w-full sm:w-auto" icon={<img src={WHATSAPP_ICON} alt="WhatsApp" className="w-6 h-6" />} />
            </div>
          </div>
          ...
          <div className="relative reveal order-1 lg:order-2">
            <div className="relative z-10 rounded-[3rem] overflow-hidden border-8 border-white shadow-2xl group aspect-square w-full max-w-md mx-auto lg:max-w-none">
              <img src={TEAM_PHOTO} alt="Equipe Profissional Alpha" className="w-full h-full object-cover object-top" />
            ...
            {!isMobile && (
              <MovingBorder borderRadius="2.5rem" duration={4000} containerClassName="absolute -bottom-10 -right-10 max-w-xs z-30 shadow-2xl" className="bg-white p-8 border-blue-50 flex-col items-start justify-start text-blue-950">
                <p className="text-sm font-bold text-blue-950 mb-4 italic">"Nossa equipe é treinada para resolver seu problema com discrição e eficiência."</p>
